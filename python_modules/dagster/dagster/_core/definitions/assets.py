...
class AssetsDefinition(ResourceAddable, IHasInternalInit):
    ...
    def map_asset_specs(self, fn: Callable[[AssetSpec], AssetSpec]) -> "AssetsDefinition":
        ...
        return _thread_deps_to_node(assets_def_new_specs, additional_deps_per_key)
...
def _thread_deps_to_node(
    ...
    additional_ins = {
        input_name: In(dagster_type=Nothing) for input_name in additional_input_names_by_key
    }
